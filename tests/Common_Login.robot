...
1.2 - Kim Registration With Existing Username
    ...
    [Tags]    registration    negative    kim    created_by:sumeyyesaglam    new-feature
    # First registration
...
1.4 - Kim Successful Login
    ...
    [Tags]    login    positive    kim    created_by:sumeyyesaglam    new-feature
    # First register
    Given Navigate To Registration Page
...
1.5 - Kim Failed Login With Wrong Password
    ...
    [Tags]    login    negative    kim    created_by:sumeyyesaglam    new-feature
    # First register  
    Given Navigate To Registration Page
    And Fill Registration Form    ${KIM_USERNAME}    ${KIM_PASSWORD}
    And Page Should Contain    Registration successful
...
2.1 - Stina-Palle Successful Registration
    ...
    [Tags]    registration    positive    stina-palle    created_by:sumeyyesaglam    new-feature
    Given Navigate To Registration Page
...
2.2 - Stina-Palle Registration With Existing Username
    ...
    [Tags]    registration    negative    stina-palle    created_by:sumeyyesaglam    new-feature
    # First registration
    Navigate To Registration Page
...
2.4 - Stina-Palle Successful Login
    ...
    [Tags]    login    positive    stina-palle    created_by:sumeyyesaglam    new-feature
    # First register
    Given Navigate To Registration Page
...
2.5 - Stina-Palle Failed Login With Wrong Password
    ...
    [Tags]    login    negative    stina-palle    created_by:sumeyyesaglam    new-feature
    # First register
    Given Navigate To Registration Page
    And Fill Registration Form    ${STINA_USERNAME}    ${STINA_PASSWORD}
    And Wait Until Page Contains    Registration successful    timeout=10s
